...
- **PR #14 (`7855d4b`) — drive-path stale-status fix (the last mile for Gooner).** After the
  hardening, the held-exit spike cleared Indexxx but Gooner's *drive verb* still failed "could
